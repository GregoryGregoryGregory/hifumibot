...
exports.helpHandle = function (msg, suffix) {
  ...
  var msgArraytwo = []
    ...
    msgArray.push('**Fun:** `' + config.settings.prefix + 'ball` `' + config.settings.prefix + 'choose` `' + config.settings.prefix + 'coinflip` `' + config.settings.prefix + 'dice` `' + config.settings.prefix + 'gif` `' + config.settings.prefix + 'leetspeak` `' + config.settings.prefix + 'rate` `' + config.settings.prefix + 'roll` `' + config.settings.prefix + 'rps` `' + config.settings.prefix + 'say` `' + config.settings.prefix + 'talk`')
